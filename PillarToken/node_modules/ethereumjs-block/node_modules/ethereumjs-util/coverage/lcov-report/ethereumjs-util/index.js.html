...
665
666
667</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const createKeccakHash = require('keccak')
...
&nbsp;
  ...
  s = new BN(s)
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (r.isZero() || r.gt(SECP256K1_N) || s.isZero() || s.gt(SECP256K1_N)) {
<span class="cstat-no" title="statement not covered" >    return false</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if ((homestead === false) &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >new BN(s).cmp(SECP256K1_N_DIV_2) === 1)</span>) {
<span class="cstat-no" title="statement not covered" >    return false</span>
  }
&nbsp;
  return true
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Feb 09 2017 20:26:53 GMT-0500 (EST)
</div>
</div>
